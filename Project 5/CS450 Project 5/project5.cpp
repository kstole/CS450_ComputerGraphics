//	Project 5: Shaders
//
//	The objective is to use vertex and fragment shaders.
//
...
const char *WINDOWTITLE = { "OpenGL / Project 5 -- Kyler Stole" };
...
bool    VshaderOn;              // vertex shader on
bool    FshaderOn;              // fragment shader on
bool    Light0On;
bool    Light1On;
bool    Light2On;
...
void Display() {
    ...
    glLoadIdentity();
    glColor3f(1., 1., 1.);
    DoRasterString(5., 5., 0., "Kyler Stole - CS 450 - Project 5");
...
void Keyboard(unsigned char c, int x, int y) {
    ...
    switch (c) {
        ...
        case 'b': case 'B':
            // Show both the vertex and fragment shaders
            VshaderOn = 1;
            FshaderOn = 1;
            break;
