...
const char *WINDOWTITLE = { "OpenGL / Project 1 -- Kyler Stole" };
...
float   Time;                   // current time in animation cycle
...
//        if (y == 40) glColor3f(0, 0, 128/255.);
//        else if (y == 80) glColor3f(128/255., 0, 128/255.);
//        else if (y == 120) glColor3f(128/255., 0, 0);
//        else if (y == 160) glColor3f(0, 128/255., 0);
...
//    DoRasterString(0., 1., 0., "Wha!!!");
    ...
    glLoadIdentity();
    glColor3f(1., 1., 1.);
    DoRasterString(5., 5., 0., "Kyler Stole");
